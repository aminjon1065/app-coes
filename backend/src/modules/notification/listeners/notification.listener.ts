...
export class NotificationListener {
  ...
  private async notifyTask(eventType: string, payload: DomainEvent) {
    ...
    const filteredRecipients = recipients.filter((userId) => userId !== payload.actorId);
    ...
    switch (eventType) {
      case 'incident.status_changed':
        return {
          ...
          link,
          metadata: { incidentId: payload.incidentId, eventId: this.eventId(eventType, payload) },
        };
    ...
    switch (eventType) {
      case 'task.assigned':
        return {
          ...
          link,
          metadata: { taskId: payload.taskId, eventId: this.eventId(eventType, payload) },
        };
      case 'task.commented':
        return {
          ...
          link,
          metadata: { taskId: payload.taskId, commentId: payload.commentId, eventId: this.eventId(eventType, payload) },
        };
