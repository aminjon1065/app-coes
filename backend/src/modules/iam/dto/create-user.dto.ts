...
import { IsEmail, IsString, IsOptional, Length, Min, Max, IsInt } from 'class-validator';
...
export class CreateUserDto {
  ...
  @ApiProperty({ example: 'Admin123!', description: 'Min 8 chars, at least 1 upper, 1 number' })
  @IsString()
  @Length(8, 128)
  password: string;
